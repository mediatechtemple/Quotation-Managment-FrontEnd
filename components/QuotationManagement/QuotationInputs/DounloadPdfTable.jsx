...
const DounloadPdfTable = ({formData}) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <CustomerDetailsTable formData={formData} />
        <AboutCar formData={formData}/>
        <PriceDetail formData={formData}/>
        <TaxDetail formData={formData}/>
        <InsuranceAccessoriesTable formData={formData}/>
        <DealTable />
        <BankDetailsTable formData={formData}/>
      </div>
    </div>
  );
};

export default DounloadPdfTable;
